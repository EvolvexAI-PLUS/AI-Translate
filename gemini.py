...
# 🎵 PERFECT AUDIO SETTINGS FOR GEMINI LIVE
FORMAT = pyaudio.paInt16          # 16-bit signed integer
CHANNELS = 1                     # Stereo audio
SEND_SAMPLE_RATE = 16000          # Google's optimal 16kHz for speech input
RECEIVE_SAMPLE_RATE = 28000       # Gemini Live audio output rate
CHUNK_SIZE = 1024                 # 2048 samples = 128ms latency at 16kHz
